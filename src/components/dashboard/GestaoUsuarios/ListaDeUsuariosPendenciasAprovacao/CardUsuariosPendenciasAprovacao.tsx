// src/components/dashboard/Gestao/PessoaUsuaria/ListaDeUsuarios/index.tsx
"use client";
      ...
      {usuarios.map((usuario) => (
        ...
        >
          ...
          <CardHeader className="pb-3">
            ...
            <p className="text-sm text-[#42474A]">{usuario.perfil}</p>
          </CardHeader>
          ...
          <CardContent className="flex-1 space-y-4 text-sm text-[#42474A]">
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <p className="break-all text-[#42474A]">{usuario.email}</p>
              </div>
            </div>
          ...
          <CardFooter className="border-slate-200 px-6 py-4">
