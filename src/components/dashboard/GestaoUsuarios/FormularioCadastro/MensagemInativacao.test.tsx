...
describe('MensagemInativacao', () => {
    ...
    it('deve renderizar mensagem de inativação via unidade quando inativadoViaUnidade é true', () => {
        render(<MensagemInativacao {...defaultProps} inativadoViaUnidade={true} />);
    ...
    it('deve ter role="alert" e aria-label correto', () => {
        ...
        expect(alertElement).toHaveAttribute('aria-label', 'Informações sobre inativação do perfil');
    });
